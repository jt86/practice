...
def get_madelon_data():
    ...
    with open("/Volumes/LocalDataHD/jt306/Desktop/Privileged_Data/MADELON/madelon_train.data","r+") as file:
        features_array = np.genfromtxt(file, dtype=None)
        features_array.shape=(2000,500)

    with open("/Volumes/LocalDataHD/jt306/Desktop/Privileged_Data/MADELON/madelon_train.labels","r+") as file:
