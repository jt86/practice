...
def get_plots(toporbottom):
    ...
    plt.plot(list_of_percentages,lupi_vs_rfe_list,label='vs RFE',linestyle=':',linewidth=5)
    plt.plot(list_of_percentages,lupi_vs_all_list,label='vs ALL',linewidth=5)
    ...
    plt.plot(list_of_percentages,lupi_vs_rfe_mean*100,label='vs RFE',linestyle=':',linewidth=5)
    plt.plot(list_of_percentages,lupi_vs_all_mean*100,label='vs ALL',linewidth=5)
    plt.xlabel('{} % of unselected features used'.format(toporbottom.title()),fontsize=fontsize)
