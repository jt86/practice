...
def single_fold(k, topk, dataset,datasetnum, kernel, cmin,cmax,number_of_cs, skfseed, classifier_type, percent_of_priv=100):
        stepsize=0.1
        np.random.seed(k)
...
single_fold(k=9, topk=5, dataset='arcene', datasetnum=3, kernel='linear', cmin=-3, cmax=3, number_of_cs=7,skfseed=3, classifier_type='lupi', percent_of_priv=100)