                    ...
                    for gamma_value in gamma_values:
                        for c_star_value in c_values:
                            for gamma_star_value in gamma_star_values:
                                ...
                                j += 1
        # logging.info( "dict_of_parameters", dict_of_parameters)
        # logging.info( "code with scores", code_with_score)
            ...
            for gamma_value in gamma_values:
                for c_star_value in c_values:
                    for gamma_star_value in gamma_star_values:
                        ...
                        # logging.info( 'testing_labels',testing_labels)
                        # logging.info( 'type of label', type(testing_labels[0]))
                        # logging.info( 'predictions this fold', predictions_this_fold)
