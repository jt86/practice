...
def param_estimation(param_estimation_file, training_features, training_labels, c_values, rs, privileged, privileged_training_data = None, peeking = False, testing_features=None, testing_labels = None, multiplier=1):


    # print "training_features[0]:"
    # print training_features[0:5, :6]
    gamma_values = get_gamma_from_c(c_values, training_features)

    if peeking == True:
        # print 'doing param selection by peeking at test data'
        return peeking_param_estimation(param_estimation_file, training_features, training_labels, c_values,  privileged, privileged_training_data , testing_features, testing_labels, multiplier)
        ...
        for train_indices, test_indices in rs:
            ...
            nested_fold +=1
            # print "length of training features", len(training_features)
            ...
            if privileged == True:
                ...
                gamma_star_values = [value*multiplier for value in get_gamma_from_c(c_values,privileged_train_this_fold)]
                for c_value in c_values:
                    for gamma_value in gamma_values:
                        for c_star_value in c_values:
                            for gamma_star_value in gamma_star_values:
                                dict_of_parameters[j] = [c_value, gamma_value, c_star_value, gamma_star_value]
                                alphas, bias = svmplusQP(X=train_this_fold, Y=train_labels_this_fold, Xstar = privileged_train_this_fold,
                                                         C = c_value,  Cstar = c_value, gamma = gamma_value, gammastar=gamma_value)
                                ...
                                j+=1
        # print "dict_of_parameters", dict_of_parameters
        # print "code with scores", code_with_score
...
def peeking_param_estimation(param_estimation_file, training_features, training_labels, c_values, privileged, privileged_training_data = None, testing_features = None, testing_labels = None, multiplier=1):
    ...
    if privileged == True:
        ...
        for c_value in c_values:
                for gamma_value in gamma_values:
                    for c_star_value in c_values:
                        for gamma_star_value in gamma_star_values:
                            dictionary0[j] = [c_value, gamma_value, c_star_value, gamma_star_value]

                            alphas, bias = svmplusQP(X=training_features, Y=training_labels, Xstar = privileged_training_data,
                                                     C = c_value,  Cstar = c_star_value, gamma = gamma_value, gammastar=gamma_star_value)
                            ...
                            # print 'type of label', type(testing_labels[0])
                            # print 'predictions this fold', predictions_this_fold
