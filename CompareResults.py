...
list_of_lupi_errors2 = list_of_lupi_errors2[np.argsort(list_of_lupi_errors)]
...
plt.errorbar(list(range(num_datasets)), list_of_lupi_errors, yerr = lupi_error_bars, color='red', label='LUPI - 300 selected, rest priv')
plt.errorbar(list(range(num_datasets)), list_of_lupi_errors2, yerr = lupi_error_bars, color='cyan', label='LUPI - 300 selected, top50% rest priv')



fig.suptitle('Comparison - all privileged vs top 50%', fontsize=20)
