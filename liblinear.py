...
if find_library('linear'):
	...
	if sys.platform == 'win32':
		...
		# liblinear = CDLL(os.path.join(os.path.dirname(__file__),\
		# 		'/liblinear-master/liblinear.so.1'))
		liblinear = CDLL('/Volumes/LocalDataHD/j/jt/jt306/PycharmProjects/FeatureSelectionPython278/liblinear-master/liblinear.so.1')
