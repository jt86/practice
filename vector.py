...
class CVectorKernel(CKernel):
    ...
    #
    def K(self, x1, x2):
        raise NotImplementedError('CVectorKernel.K in abstract class is not implemented')
    ...
    def Dot(self, x1, x2, index1=None, index2=None, output=None):
        raise NotImplementedError('CVectorKernel.Dot in abstract class is not implemented')
    ...
    def Expand(self, x1, x2, alpha2, index1=None, index2=None):
        raise NotImplementedError('CVectorKernel.Expand in abstract class is not implemented')
    ...
    def Tensor(self, x1, y1, x2, y2, index1=None, index2=None):
        raise NotImplementedError('CVectorKernel.Tensor in abstract class is not implemented')
    ...
    def Forget(self, x=None):
        ...
        if x is not None:
            ...
            if (id(x) in self._cacheData) is False:
                return False
            else:
...
class CLinearKernel(CVectorKernel):
    ...
    def Dot(self, x1, x2, index1=None, index2=None, output=None):
        ...
        n2 = x2.shape[0]
        # number of blocks.
        nb = n1 // self._blocksize                  #changed for Python 3
