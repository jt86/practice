...
# single_fold(k=9, topk=300, dataset='tech', datasetnum=31, kernel='linear', cmin=-3, cmax=3, number_of_cs=4,skfseed=7, percent_of_priv=20, percentageofinstances=100, take_top_t='top')
