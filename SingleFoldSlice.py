...
def single_fold(k, topk, dataset,datasetnum, kernel, cmin,cmax,number_of_cs, skfseed, percent_of_priv=100):
        ...
        outer_directory = get_full_path('Desktop/Privileged_Data/10x10-29onlyhalformalised/')#.format(c_star_svm_plus))
...
#     rfe_score, all_score,lupi_score = single_fold(k=fold, topk=300, dataset='tech', datasetnum=29, kernel='linear', cmin=0, cmax=4, number_of_cs=5,skfseed=1, percent_of_priv=100)
#     mean_all+=all_score
#     mean_rfe+=rfe_score
