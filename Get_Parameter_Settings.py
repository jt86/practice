...
pattern = '--input {} --num-folds 5 --rank-metric r2 --prop-priv 1 --gamma-multiplier 1 --bottom-n-percent 0 --cmin -6 --cmax 0 --numberofcs 7 {} --cstarmin {} --cstarmax {}'
