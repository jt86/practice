...
# inputs = ['arcene', 'gisette', 'dorothea','madelon','dexter']
inputs = ['madelon','dexter']

bottom_n_values = [0]
peeking_allowed = False
pattern = '--input {} --num-folds 5 --rank-metric r2 --prop-priv 1 --gamma-multiplier 1 --bottom-n-percent 0 --cmin -4 --cmax 1 --cstarmin 0 --cstarmax 5 --numberofcs 6 {}'
