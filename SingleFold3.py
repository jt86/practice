...
def single_fold(k, topk, dataset,datasetnum, kernel, cmin,cmax,number_of_cs, percent_of_priv=50):
        ...
        output_directory = os.path.join(get_full_path(outer_directory),'not-fixedC-25-75-{}-{}-RFE-baseline-step={}-percent_of_priv={}top'.format(dataset,datasetnum,stepsize,percent_of_priv))
